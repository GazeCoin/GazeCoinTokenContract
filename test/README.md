...
* Geth/v1.7.1-unstable-5705ad00/darwin-amd64/go1.7.1
...
* The tests were conducted using bash shell scripts running Geth/v1.7.1-unstable-5705ad00/darwin-amd64/go1.7.1 JavaScript commands
